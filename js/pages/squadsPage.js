                ...
                <form id="squad-form">
                    ...
                    <div class="form-group">
                        ...
                        <p style="color: var(--text-secondary); font-size: 0.9rem; margin-bottom: 0.5rem;">
                            Líder do squad — custo rateado automaticamente entre os clientes do squad,
                            proporcional ao volume de vídeo + estático de cada um. Não precisa lançar nada manualmente.
                        </p>
            ...
            <div class="list-item">
                ...
                <div class="list-item-body">
                    <div class="list-item-meta">
                        ...
                        ${head ? `
                            <div class="list-item-meta-item">
                                <strong>Custo Head (rateado por volume):</strong> R$ ${formatCurrency(squad.headId ? head.salary : 0)}
                            </div>
                        ` : ''}
                        <div class="list-item-meta-item">
